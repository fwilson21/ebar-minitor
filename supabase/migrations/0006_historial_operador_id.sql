-- ============================================================================
-- EBAR Monitor — Exponer operador_id en el historial de estación
-- ============================================================================
-- Necesario para que el cliente sepa si el usuario actual puede editar cada
-- visita (operador propio, o administrador/supervisor) antes de mostrar el
-- enlace de "Editar" en el historial.
-- ============================================================================
